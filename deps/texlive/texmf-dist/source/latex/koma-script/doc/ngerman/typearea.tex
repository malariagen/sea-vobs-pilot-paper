...
\fi %
  ...
  \Package{setspace}-Pakets\IndexPackage{setspace} (siehe
  \cite{package:setspace}) wie folgt aus:
\begin{lstcode}
  \documentclass[10pt,twoside,BCOR=12mm,DIV=calc]
                {scrreprt}
...
\DescRef{scrlayer.option.singlespacing} in \autoref{cha:scrlayer} auf
